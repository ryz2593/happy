...
public class GeoHashUtil {
    ...
    public static String getGeoHashCode(double lng, double lat) {
        return new GeoHash(lat, lng, 7).getGeoHashBase32();
    }
     ...
     * @param lng    经度
     * @param lat    纬度
     * @param length code长度，取值范围：1-8，数字越大精度越高
     * @return
     */
    public static String getGeoHashCode(double lng, double lat, int length) {
        return new GeoHash(lat, lng, length).getGeoHashBase32();
    }
     ...
     * @return
     */
    public static double getDistance(double sln, double sla, double eln, double ela) {
        double slon = sln * ratio;
        double slat = sla * ratio;
        double elon = eln * ratio;
        double elat = ela * ratio;

        double c = Math.sin(slat) * Math.sin(elat) * Math.cos(slon - elon) + Math.cos(slat) * Math.cos(elat);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(GeoHashUtil.getGeoHashCode(116.249183, 40.222012));
        System.out.println(GeoHashUtil.getGeoHashCode(116.249183, 40.222013, 8));
        System.out.println(GeoHashUtil.getDistance(116.249183, 40.222912, 116.249183, 40.222412));
    }


    /**
     * GeoHash实现经纬度的转化
     * Created by ryz2593 on 2017/12/29.
     */
    ...
    private static class GeoHash {
        ...
        public GeoHash(double lat, double lng, int length) {
